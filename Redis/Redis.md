...
- [4. 启动](#4-启动)
- [5. 命令](#5-命令)
  - [5.1. General command](#51-general-command)
  - [5.2. KEYS](#52-keys)
...
- [6. 基本数据类型](#6-基本数据类型)
  ...
  - [6.6. rpoplpush](#66-rpoplpush)
- [7. 持久化](#7-持久化)
  - [7.1. RDB](#71-rdb)
  - [7.2. AOF](#72-aof)
- [8. 事务](#8-事务)
- [9. pub/sub](#9-pubsub)
  - [9.1. pubsub的不足之处处](#91-pubsub的不足之处处)
  - [9.2. 优缺点](#92-优缺点)
  - [9.3. 用途](#93-用途)
  - [9.4. 消息队列出现解决的问题](#94-消息队列出现解决的问题)
- [10. stream](#10-stream)
  - [10.1. 特性](#101-特性)
  - [10.2. 改进点](#102-改进点)
  - [10.3. stream的不足](#103-stream的不足)
- [11. tair](#11-tair)
  - [11.1. Tair持久内存版特性](#111-tair持久内存版特性)
- [12. Master/Slave replication](#12-masterslave-replication)
- [13. Redis 连接](#13-redis-连接)
- [14. Redis Server](#14-redis-server)
- [15. HyperLogLog](#15-hyperloglog)
- [16. 集群(cluster)](#16-集群cluster)
- [17. 集群方案优化](#17-集群方案优化)
- [18. 数据一致性](#18-数据一致性)
- [19. 高并发访问](#19-高并发访问)
- [20. 分布式锁](#20-分布式锁)
- [21. 典型问题](#21-典型问题)
  - [21.1. Redis 上踩过的坑](#211-redis-上踩过的坑)
  - [21.2. 缓存基本原理](#212-缓存基本原理)
  - [21.3. 缓存淘汰策略](#213-缓存淘汰策略)
  - [21.4. 缓存穿透](#214-缓存穿透)
  - [21.5. 缓存击穿](#215-缓存击穿)
  - [21.6. 缓存雪崩](#216-缓存雪崩)
- [22. 参考](#22-参考)
