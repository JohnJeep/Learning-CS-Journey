 ...
 * @LastEditTime: 2022-12-27 22:37:23
 * @Description: C++基础学习笔记
 * Copyright (c) 2022 by johnjeep, All Rights Reserved. 
-->

- [concept(概念)](#concept概念)
- [c++ basics(C++基础)](#c-basicsc基础)
- [namespace(命名空间)](#namespace命名空间)
- [header file(头文件)](#header-file头文件)
- [reference(引用)](#reference引用)
  - [ordinary reference(普通引用)](#ordinary-reference普通引用)
  - [lvalue reference(左值引用)](#lvalue-reference左值引用)
  - [rvalue reference(右值引用)](#rvalue-reference右值引用)
  - [const reference(常量引用)](#const-reference常量引用)
- [function(函数)](#function函数)
  - [inline(内联函数)](#inline内联函数)
  - [function parameter(函数参数)](#function-parameter函数参数)
  - [template function(模板函数)](#template-function模板函数)
  - [conversion function(转换函数)](#conversion-function转换函数)
  - [functor(仿函数)](#functor仿函数)
- [Special member function (类中特别的成员函数)](#special-member-function-类中特别的成员函数)
  - [constructor(构造函数)](#constructor构造函数)
  - [copy constructor(拷贝构造)](#copy-constructor拷贝构造)
  - [copy assignment operator(拷贝赋值)](#copy-assignment-operator拷贝赋值)
  - [Move constructor(移动构造)](#move-constructor移动构造)
  - [Move assignment operator(移动赋值操作)](#move-assignment-operator移动赋值操作)
  - [destructor(析构函数)](#destructor析构函数)
- [empty class](#empty-class)
- [class object \&\& class pointer(类对象与类指针的区别)](#class-object--class-pointer类对象与类指针的区别)
- [new \&\& delete](#new--delete)
- [overload(重载)](#overload重载)
- [override(重写)](#override重写)
- [const](#const)
- [static](#static)
- [this](#this)
- [mutable](#mutable)
  - [mutable是什么？](#mutable是什么)
  - [为什么要用mutable？](#为什么要用mutable)
  - [使用 mutable 的注意事项](#使用-mutable-的注意事项)
  - [常函数](#常函数)
- [pass by value \&\& pass by reference(参数传递与返回值传递)](#pass-by-value--pass-by-reference参数传递与返回值传递)
- [friend(友元)](#friend友元)
- [operator overloading(操作运算符重载)](#operator-overloading操作运算符重载)
- [smart pointer(智能指针)](#smart-pointer智能指针)
  - [为什么要使用智能指针？](#为什么要使用智能指针)
  - [智能指针原理](#智能指针原理)
  - [使用智能指针的优点](#使用智能指针的优点)
  - [auto\_ptr](#auto_ptr)
  - [unique\_ptr](#unique_ptr)
    - [概述](#概述)
    - [为什么要用 unique\_ptr](#为什么要用-unique_ptr)
    - [初始化](#初始化)
    - [成员函数](#成员函数)
    - [unique\_ptr 删除器](#unique_ptr-删除器)
  - [shared\_ptr](#shared_ptr)
    - [概述](#概述-1)
    - [为什么要使用 shared\_ptr](#为什么要使用-shared_ptr)
    - [成员函数](#成员函数-1)
    - [底层原理](#底层原理)
    - [初始化](#初始化-1)
    - [用法](#用法)
    - [shared\_ptr 删除器](#shared_ptr-删除器)
    - [注意点](#注意点)
  - [weak\_ptr](#weak_ptr)
    - [概述](#概述-2)
    - [为什么要使用 weak\_ptr](#为什么要使用-weak_ptr)
    - [初始化](#初始化-2)
    - [底层原理](#底层原理-1)
    - [成员函数](#成员函数-2)
    - [注意点](#注意点-1)
- [typename](#typename)
  - [概念](#概念)
  - [为什么要用 typename ?](#为什么要用-typename-)
  - [注意点](#注意点-2)
- [explicit conversions(显示类型转换)](#explicit-conversions显示类型转换)
  - [static\_cast\<\>()](#static_cast)
  - [reinterpret\_cast\<\>()](#reinterpret_cast)
  - [dynamic\_cast\<\>()](#dynamic_cast)
  - [const\_cast\<\>()](#const_cast)
- [exception(异常处理)](#exception异常处理)
  - [异常变量的生命周期](#异常变量的生命周期)
  - [异常的层次结构](#异常的层次结构)
  - [异常的优缺点](#异常的优缺点)
  - [构造函数中的异常](#构造函数中的异常)
- [meaningful aphorisms (隽永警句)](#meaningful-aphorisms-隽永警句)
- [Reference by website(学习参考)](#reference-by-website学习参考)
...
# Special member function (类中特别的成员函数)
...
## Move assignment operator(移动赋值操作)
...
# class object && class pointer(类对象与类指针的区别)
...
- 重载是在编译期间 根据参数列表决定，重写是在 运行期间 根据具体对象类型来决定调用的函数。
</font>
...
# pass by value && pass by reference(参数传递与返回值传递)
