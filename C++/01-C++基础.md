...
- [1. C++ Basics(C++基础)](#1-c-basicsc基础)
  - [1.1. StyleGuide(规范)](#11-styleguide规范)
  - [1.2. Concept(概念)](#12-concept概念)
  - [1.3. Namespace(命名空间)](#13-namespace命名空间)
  - [1.4. Header file(头文件)](#14-header-file头文件)
  - [1.5. Reference(引用)](#15-reference引用)
    - [1.5.1. 普通引用](#151-普通引用)
    - [1.5.2. lvalue reference(左值引用)](#152-lvalue-reference左值引用)
    - [1.5.3. rvalue reference(右值引用)](#153-rvalue-reference右值引用)
    - [1.5.4. const reference(常量引用)](#154-const-reference常量引用)
  - [1.6. function(函数)](#16-function函数)
    - [1.6.1. inline(内联函数)](#161-inline内联函数)
    - [1.6.2. function parameter(函数参数)](#162-function-parameter函数参数)
    - [1.6.3. template function(模板函数)](#163-template-function模板函数)
    - [1.6.4. conversion function(转换函数)](#164-conversion-function转换函数)
    - [1.6.5. functor(仿函数)](#165-functor仿函数)
  - [1.7. constructor(构造函数)](#17-constructor构造函数)
    - [1.7.1. copy constructor(拷贝构造)](#171-copy-constructor拷贝构造)
    - [1.7.2. copy assignment operator(拷贝赋值)](#172-copy-assignment-operator拷贝赋值)
  - [1.8. destructor(析构函数)](#18-destructor析构函数)
  - [1.9. class object && class pointer(类对象与类指针的区别)](#19-class-object--class-pointer类对象与类指针的区别)
  - [1.10. new && delete](#110-new--delete)
  - [1.11. overloading(重载)](#111-overloading重载)
  - [1.12. overwrite(重写)](#112-overwrite重写)
  - [1.13. const](#113-const)
  - [1.14. static](#114-static)
  - [1.15. this](#115-this)
  - [1.16. mutable](#116-mutable)
  - [1.17. pass by value && pass by reference(参数传递与返回值传递)](#117-pass-by-value--pass-by-reference参数传递与返回值传递)
  - [1.18. friend(友元)](#118-friend友元)
  - [1.19. operator overloading(操作运算符重载)](#119-operator-overloading操作运算符重载)
  - [1.20. C++典型问题](#120-c典型问题)
    - [1.20.1. `.h`与 `.hpp` 文件区别](#1201-h与-hpp-文件区别)
    - [1.20.2. ++i与i++效率问题](#1202-i与i效率问题)
    - [1.20.3. 传值、传引用、传指针三者的区别](#1203-传值传引用传指针三者的区别)
  - [1.21. smart pointer(智能指针)](#121-smart-pointer智能指针)
    - [1.21.1. auto_ptr](#1211-auto_ptr)
    - [1.21.2. unique_ptr](#1212-unique_ptr)
      - [1.21.2.1. 概述](#12121-概述)
      - [1.21.2.2. 为什么要用 unique_ptr](#12122-为什么要用-unique_ptr)
      - [1.21.2.3. <font color=red> 注意点</font>](#12123-font-colorred-注意点font)
      - [1.21.2.4. 成员函数](#12124-成员函数)
    - [1.21.3. shared_ptr](#1213-shared_ptr)
      - [1.21.3.1. 概述](#12131-概述)
      - [1.21.3.2. 为什么要使用 shared_ptr](#12132-为什么要使用-shared_ptr)
      - [1.21.3.3. 成员函数](#12133-成员函数)
      - [1.21.3.4. 底层原理](#12134-底层原理)
      - [1.21.3.5. 注意点](#12135-注意点)
    - [1.21.4. weak_ptr](#1214-weak_ptr)
      - [1.21.4.1. 概述](#12141-概述)
      - [1.21.4.2. 为什么要使用 weak_ptr](#12142-为什么要使用-weak_ptr)
      - [1.21.4.3. 底层原理](#12143-底层原理)
      - [1.21.4.4. 注意点](#12144-注意点)
  - [1.22. typename](#122-typename)
  - [1.23. Explicit Conversions(显示类型转换)](#123-explicit-conversions显示类型转换)
  - [1.24. Exception(异常处理)](#124-exception异常处理)
  - [1.25. Reference by website(学习参考)](#125-reference-by-website学习参考)
...
### 1.6.3. template function(模板函数)
- 什么是模板函数？
  - 函数定义时不指定具体的数据类型，建立一个通用函数。函数调用时，根据实际的参数反推数据类型，即类型的参数化。


### 1.6.4. conversion function(转换函数)
...
### 1.7.2. copy assignment operator(拷贝赋值) 
  ```C++
...
## 1.9. class object && class pointer(类对象与类指针的区别)
```C++
class Stu
{
private:
...
## 1.17. pass by value && pass by reference(参数传递与返回值传递)
...
## 1.19. operator overloading(操作运算符重载)
- 为什么要操作符重载？
...
#### 1.21.2.2. 为什么要用 unique_ptr
它对于避免资源泄露(例如以new创建对象后因为发生异常而忘记调用delete)特别有用。 


#### 1.21.2.3. <font color=red> 注意点</font>
...
## 1.23. Explicit Conversions(显示类型转换)
C++中的类型转换有4种。
...
## 1.25. Reference by website(学习参考)
