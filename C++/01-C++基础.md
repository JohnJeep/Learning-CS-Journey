 ...
 * @LastEditTime: 2021-05-18 21:18:54
...
- [22. smart pointer(智能指针)](#22-smart-pointer智能指针)
  ...
  - [22.5. unique_ptr](#225-unique_ptr)
    ...
    - [22.5.3. <font color=red> 注意点</font>](#2253-font-colorred-注意点font)
...
### 22.5.3. <font color=red> 注意点</font>
...
- `get()` 获得被 `shared_ptr` 包裹凡人内部对象(指针), 提供完全的指针语义。由于已经重载了`()`方法, 因此和直接使用对象是一样的。
