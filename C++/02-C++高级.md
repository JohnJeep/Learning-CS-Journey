...
- [Object Oriented Programming(面向对象编程)](#object-oriented-programming面向对象编程)
  - [Encapsulation(封装)](#encapsulation封装)
  - [Composition(复合)](#composition复合)
  - [Delegation(委托)](#delegation委托)
    - [copy on write](#copy-on-write)
    - [pImpl](#pimpl)
  - [Inheritance(继承)](#inheritance继承)
    - [父类与子类的关系](#父类与子类的关系)
    - [继承中的构造与析构调用原则](#继承中的构造与析构调用原则)
    - [继承中同名成员变量处理方法](#继承中同名成员变量处理方法)
    - [Composite, Inheritance 和 Delegation 对比](#composite-inheritance-和-delegation-对比)
    - [Inheritance and virtual function](#inheritance-and-virtual-function)
  - [Polymorphism(多态)](#polymorphism多态)
    - [虚析构函数](#虚析构函数)
    - [vptr(虚指针)和vtbl(虚函数表)](#vptr虚指针和vtbl虚函数表)
    - [纯虚函数和抽象类](#纯虚函数和抽象类)
  - [耦合与解耦](#耦合与解耦)
- [Generic Programming(泛型编程)](#generic-programming泛型编程)
  - [Parameterized Type(参数化类型)](#parameterized-type参数化类型)
  - [模板编译](#模板编译)
  - [Function Template(函数模板)](#function-template函数模板)
  - [Class Template(类模板)](#class-template类模板)
    - [Specialization(模板特化)](#specialization模板特化)
    - [Class Partial Specialization(类模板偏特化)](#class-partial-specialization类模板偏特化)
  - [Member Template(成员模板)](#member-template成员模板)
  - [template template parameter](#template-template-parameter)
- [IOStream(输入输出流)](#iostream输入输出流)
- [std::move()](#stdmove)
- [Meata Programming(元编程)](#meata-programming元编程)
- [Resource acquisition is initialization(RAII)](#resource-acquisition-is-initializationraii)
...
### Composite, Inheritance 和 Delegation 对比
...
### Class Partial Specialization(类模板偏特化)
