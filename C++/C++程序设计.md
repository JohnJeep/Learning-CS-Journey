 ...
 * @LastEditTime: 2023-06-09 18:53:15
...
- [1. .1. 简单就是最好的 ---\> 大道至简。](#1-1-简单就是最好的-----大道至简)
- [2. .2. 重用哲学](#2-2-重用哲学)
  - [2.1. .2.1. 如何设计可重用代码](#21-21-如何设计可重用代码)
- [3. .2. 软件设计考虑的原则](#3-2-软件设计考虑的原则)
- [4. .3. 优美命名](#4-3-优美命名)
  - [4.1. 管理类命名](#41-管理类命名)
  - [4.2. 传播类命名](#42-传播类命名)
  - [4.3. 回调类命名](#43-回调类命名)
  - [4.4. 监控类命名](#44-监控类命名)
  - [4.5. 内存管理类命名](#45-内存管理类命名)
  - [4.6. 过滤检测类命名](#46-过滤检测类命名)
  - [4.7. 结构类命名](#47-结构类命名)
  - [4.8. 解析类命名](#48-解析类命名)
  - [4.9. 网络命名](#49-网络命名)
  - [4.10. 其它](#410-其它)
- [5. .4. 实践经验指导](#5-4-实践经验指导)
...
文献参考：https://mp.weixin.qq.com/s/-Se0olV03HLGy-Y_-60lOw
