 ...
 * @LastEditTime: 2020-06-08 14:21:43
...
public:
    void showD()
    {
        ...
        // cout << "m_a:" << m_a << endl;  // private 私有成员不能访问 
        cout << "m_b:" << m_b << endl;  // 父类的成员变为 private属性，只能子类的内部使用
        cout << "m_c:" << m_c << endl;  // 父类的成员变为 private属性，只能子类的内部使用
    }
    D(/* args */);
    ~D();
};
...
int main()
{
    ...
    D d1;
    // c1.m_c = 300; // 类的外部能调用子类 private 属性的成员变量
    // d1.set();
    d1.showD();
