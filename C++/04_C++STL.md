...
- [0.1. STL（Standard Template Library）标准模板库](#01-stlstandard-template-library标准模板库)
  - [0.1.1. Sequence containers(有序容器)](#011-sequence-containers有序容器)
    - [0.1.1.1. vector（单端的动态数组）](#0111-vector单端的动态数组)
    - [0.1.1.2. deque（双端数组）](#0112-deque双端数组)
    - [0.1.1.3. list（双向链表）](#0113-list双向链表)
  - [0.1.2. Associative containers(关联性容器)](#012-associative-containers关联性容器)
    - [0.1.2.1. set容器](#0121-set容器)
    - [0.1.2.2. map容器](#0122-map容器)
    - [0.1.2.3. multiset](#0123-multiset)
    - [0.1.2.4. mutimap](#0124-mutimap)
  - [0.1.3. Unordered associative containers(无序关联容器)](#013-unordered-associative-containers无序关联容器)
    - [0.1.3.1. unordered_set](#0131-unordered_set)
    - [0.1.3.2. unordered_map](#0132-unordered_map)
    - [0.1.3.3. unordered_multisert](#0133-unordered_multisert)
    - [0.1.3.4. unordered_multimap](#0134-unordered_multimap)
  - [0.1.4. Container adaptors(容器适配器)](#014-container-adaptors容器适配器)
    - [0.1.4.1. stack容器](#0141-stack容器)
    - [0.1.4.2. queue容器](#0142-queue容器)
    - [0.1.4.3. 优先级队列 priority_queue](#0143-优先级队列-priority_queue)
- [0.2. STL常用算法](#02-stl常用算法)

<!-- /TOC -->
## 0.1. STL（Standard Template Library）标准模板库
- 广义分类
  - 算法（Algorithm）
  - 容器（Container）
...
### 0.1.1. Sequence containers(有序容器)

#### 0.1.1.1. vector（单端的动态数组）
- 动态数组实现机制：
...
### 0.1.2. Associative containers(关联性容器)
...
### 0.1.3. Unordered associative containers(无序关联容器)


#### 0.1.3.1. unordered_set
...
#### 0.1.3.2. unordered_map


#### 0.1.3.3. unordered_multisert


#### 0.1.3.4. unordered_multimap


### 0.1.4. Container adaptors(容器适配器)
容器适配器为有序的容器提供了不同的接口。
