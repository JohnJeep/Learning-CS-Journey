 ...
 * @LastEditTime: 2021-01-17 11:47:03
...
- [1. C++高级板块](#1-c高级板块)
  - [1.1. class类](#11-class类)
  - [1.2. 封装](#12-封装)
  - [1.3. 面向对象编程(OOP)](#13-面向对象编程oop)
    - [1.3.1. 功能复用技术](#131-功能复用技术)
      - [1.3.1.1. 复合(composition)](#1311-复合composition)
      - [1.3.1.2. 委托(delegation)](#1312-委托delegation)
      - [1.3.1.3. 继承(Inheritance)](#1313-继承inheritance)
      - [1.3.1.4. Composite, Inheritance和delegation对比](#1314-composite-inheritance和delegation对比)
      - [1.3.1.5. 参数化类型(parameterized type)](#1315-参数化类型parameterized-type)
    - [1.3.2. 类型兼容原则](#132-类型兼容原则)
    - [1.3.3. 继承中的构造与析构调用原则](#133-继承中的构造与析构调用原则)
    - [1.3.4. 继承中同名成员变量处理方法](#134-继承中同名成员变量处理方法)
    - [1.3.5. 继承与虚函数(virtual function)的结合](#135-继承与虚函数virtual-function的结合)
    - [1.3.6. 多态(polymorphism)](#136-多态polymorphism)
    - [1.3.7. 纯虚函数和抽象类](#137-纯虚函数和抽象类)
  - [1.4. 耦合与解耦的概念](#14-耦合与解耦的概念)
  - [1.5. 函数模板(function template)](#15-函数模板function-template)
  - [1.6. 类模板(class template)](#16-类模板class-template)
  - [1.7. 成员模板(member template)](#17-成员模板member-template)
  - [1.8. specialization 模板特化](#18-specialization-模板特化)
  - [1.9. template template parameter](#19-template-template-parameter)
  - [1.10. 输入输出流](#110-输入输出流)
...
#### 1.3.1.4. Composite, Inheritance和delegation对比
- 继承
...
#### 1.3.1.5. 参数化类型(parameterized type)
...
### 1.3.5. 继承与虚函数(virtual function)的结合
- 为什么会有虚继承
  - 解决多个继承可能产生的二义性。 
...
## 1.9. template template parameter
- 参考
