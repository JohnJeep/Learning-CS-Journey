...
**rosbag2** 是 ROS2 系统中的官方数据记录和回放工具。它的核心功能是：

*   **记录**：将机器人运行时的话题（Topics）上的消息数据捕获并保存到磁盘文件中。
*   **回放**：将之前记录的数据文件重新发布到当前运行的 ROS2 系统中，模拟原始数据流。

简单来说，**rosbag2 就是 ROS2 的“黑匣子”或“录音机”**。
...
### rosbag2 的关键特性（与 ROS1 rosbag 的主要区别）
