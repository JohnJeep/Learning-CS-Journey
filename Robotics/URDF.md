...
#### 0.2.4.2. 基本语法（ROS 2 / `ros2_control` 兼容格式）
...
### 0.5.1. ros-humble-urdf-tutorial 
...
# 5. URDF 与 robot_state_publisher



##   5.1. 创建 package 与 URDF 文件
