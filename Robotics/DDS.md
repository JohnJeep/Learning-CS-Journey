...
CycloneDDS 是 Eclipse 基金会开发的一个轻量级、高性能的 DDS 实现，目前是 ROS 2 推荐的默认 DDS
...
- [CSDN  ROS2 DDS 中间件（图文并茂+超详细）](https://blog.csdn.net/weixin_39939185/article/details/145865272)
