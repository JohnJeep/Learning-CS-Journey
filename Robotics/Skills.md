...
1. 为什么选 DDS over RTPS 而不是传统 MQTT？
2. **DDS 如何融入 ROS2，以及为什么这么设计？**
3. DDS 的 QoS 解释？
4. ROS2 是如何与 DDS 交互的？怎样集成的？
5. 如何从网络通信层优化 ROS？
6. CyberRT 是什么？（可选）
7. **DDS 如何解决实际开发中的痛点。**
   8. 通信延迟、可靠性。通过底层原理找到解决方案
8. ROS 本身有哪些问题？
8. 网络拓扑是怎样的？拔插网线对 domain 的影响？
8. 为什么要用 cyclone 和 iceoryx?
