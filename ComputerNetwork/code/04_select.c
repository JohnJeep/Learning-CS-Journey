 ...
 * @LastEditTime: 2021-02-28 13:26:14
 * @LastEditors: Please set LastEditors
 * @Description: 多路复用IO：select的实现。
 *               此程序为Server端的编写，采用select方式实现IO多路复用，最大支持连接1024个client，
 *               select与client正常连接时，最好先连接select，再连接client。
 */
#include <string.h>
#include <unistd.h>
#include <ctype.h>
