 ...
 * @LastEditTime: 2021-08-15 16:10:32
...
- [4. 基本语法](#4-基本语法)
  - [4.1. 变量](#41-变量)
  - [4.2. 命令代换与通配符](#42-命令代换与通配符)
  - [4.3. 引号](#43-引号)
  - [4.4. test条件测试](#44-test条件测试)
  - [4.5. if 语句](#45-if-语句)
  - [4.6. case语句](#46-case语句)
  - [4.7. for 语句](#47-for-语句)
  - [4.8. while 语句](#48-while-语句)
  - [4.9. 函数](#49-函数)
  - [4.10. 命令行参数](#410-命令行参数)
  - [4.11. shell调试](#411-shell调试)
- [5. 用户输入处理](#5-用户输入处理)
- [6. 重定向](#6-重定向)
  - [6.1. tee](#61-tee)
  - [6.2. 文件重定向](#62-文件重定向)
- [7. 正则表达式](#7-正则表达式)
  - [7.1. 字符串限定符](#71-字符串限定符)
  - [7.2. 数量限定符](#72-数量限定符)
  - [7.3. 位置限定符](#73-位置限定符)
  - [7.4. 其他特殊字符](#74-其他特殊字符)
- [8. sed](#8-sed)
- [9. awk](#9-awk)
...
- `$*`: 将shell的所有参数当成单个参数。
- `$@`: 单独处理输入的每个参数。
- `$?`: 显示上一次命令的退出状态码。成功结束的命令退出状态码是 `0`。如果一个命令结束时有错误，退出状态就是一个正值；无效命令会返回一个退出状态码 `127`。
- `$$`: 显示脚本运行的当前进程ID号。
