 ...
 * @LastEditTime: 2021-03-22 19:03:19
...
- [1. Vim基础用法](#1-vim基础用法)
  ...
  - [1.2. 三种模式](#12-三种模式)
  - [1.3. 命令行模式](#13-命令行模式)
    - [1.3.1. 光标移动(命令行模式)](#131-光标移动命令行模式)
    - [1.3.2. 复制操作(命令模式)](#132-复制操作命令模式)
    - [1.3.3. 粘贴(命令模式)](#133-粘贴命令模式)
    - [1.3.4. 删除操作(命令模式)](#134-删除操作命令模式)
    - [1.3.5. 撤销操作(命令模式)](#135-撤销操作命令模式)
    - [1.3.6. visual模式(命令模式)](#136-visual模式命令模式)
    - [1.3.7. block模式(命令模式)](#137-block模式命令模式)
    - [1.3.8. 查找与替换(命令模式)](#138-查找与替换命令模式)
  - [1.4. 插入（编辑）模式](#14-插入编辑模式)
    - [1.4.1. 编辑切换(插入模式)](#141-编辑切换插入模式)
  - [1.5. 底行命令模式](#15-底行命令模式)
    - [1.5.1. 文件操作(Last line mode)](#151-文件操作last-line-mode)
    - [1.5.2. 替换](#152-替换)
    - [1.5.3. 窗口](#153-窗口)
    - [1.5.4. shell](#154-shell)
    - [1.5.5. 帮助](#155-帮助)
    - [1.5.6. 注释](#156-注释)
  - [1.6. vim配置文件](#16-vim配置文件)
  - [1.7. 恢复文件](#17-恢复文件)
