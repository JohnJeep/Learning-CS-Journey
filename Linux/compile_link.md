 ...
 * @LastEditTime: 2021-03-13 11:41:49
...
- [1. 预处理、编译、汇编、链接过程](#1-预处理编译汇编链接过程)
  - [1.1. 参考](#11-参考)
  - [1.2. 缩写](#12-缩写)
  - [1.3. 程序处理过程](#13-程序处理过程)
    - [1.3.1. 程序运行的过程](#131-程序运行的过程)
    - [1.3.2. 编译](#132-编译)
    - [1.3.3. 内存四区](#133-内存四区)
    - [1.3.4. gcc 常用参数](#134-gcc-常用参数)
    - [1.3.5. 静态库](#135-静态库)
    - [1.3.6. 动态库也叫共享库(share library)](#136-动态库也叫共享库share-library)
      - [1.3.6.1. Linux平台](#1361-linux平台)
      - [1.3.6.2. Windows平台](#1362-windows平台)
  - [1.4. ELF relocatable](#14-elf-relocatable)
  - [1.5. 工具](#15-工具)
  - [1.6. 两种编译构建方式](#16-两种编译构建方式)
