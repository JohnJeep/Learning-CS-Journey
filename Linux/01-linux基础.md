...
- [1. Linux Basic](#1-linux-basic)
  ...
  - [1.15. dmesg](#115-dmesg)
  - [1.16. vmstat](#116-vmstat)
  - [1.17. man](#117-man)
  - [1.18. ntsysv](#118-ntsysv)
  - [1.19. wget命令](#119-wget命令)
  - [1.20. 包管理](#120-包管理)
    - [1.20.1. 软件仓库](#1201-软件仓库)
    - [1.20.2. apt命令](#1202-apt命令)
    - [1.20.3. dpkg 命令](#1203-dpkg-命令)
  - [1.21. 防火墙](#121-防火墙)
    - [1.21.1. ubuntu下默认的防火墙](#1211-ubuntu下默认的防火墙)
    - [1.21.2. CentOS下默认的防火墙](#1212-centos下默认的防火墙)
  - [1.22. SELinux](#122-selinux)
  - [1.23. 参考](#123-参考)
