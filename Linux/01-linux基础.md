 ...
 * @LastEditTime: 2021-04-17 15:42:18
...
- [1. Linux Basic](#1-linux-basic)
  ...
  - [1.15. traceroute](#115-traceroute)
  - [1.16. dmesg](#116-dmesg)
  - [1.17. vmstat](#117-vmstat)
  - [1.18. man](#118-man)
  - [1.19. ntsysv](#119-ntsysv)
  - [1.20. wget命令](#120-wget命令)
  - [1.21. 包管理](#121-包管理)
    - [1.21.1. 软件仓库](#1211-软件仓库)
    - [1.21.2. apt命令](#1212-apt命令)
    - [1.21.3. dpkg 命令](#1213-dpkg-命令)
  - [1.22. 防火墙](#122-防火墙)
    - [1.22.1. ubuntu下默认的防火墙](#1221-ubuntu下默认的防火墙)
    - [1.22.2. CentOS下默认的防火墙](#1222-centos下默认的防火墙)
  - [1.23. SELinux](#123-selinux)
  - [1.24. 参考](#124-参考)
