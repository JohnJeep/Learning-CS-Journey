 ...
 * @LastEditTime: 2021-04-19 22:33:09
...
- [1. Linux Basic](#1-linux-basic)
  ...
  - [1.2. 文件I/O](#12-文件io)
    ...
    - [1.2.11. 链接](#1211-链接)
    - [1.2.12. 重定向](#1212-重定向)
    - [1.2.13. 绝对路径与相对路径](#1213-绝对路径与相对路径)
  - [1.3. 解压与压缩](#13-解压与压缩)
    - [1.3.1. 文件类型](#131-文件类型)
    - [1.3.2. tar文件打包](#132-tar文件打包)
      - [1.3.2.1. 打包文件或目录](#1321-打包文件或目录)
      - [1.3.2.2. 解包文件或目录](#1322-解包文件或目录)
      - [1.3.2.3. 解压缩文件](#1323-解压缩文件)
      - [1.3.2.4. 打包压缩](#1324-打包压缩)
    - [1.3.3. zip](#133-zip)
  - [1.4. pipe](#14-pipe)
  - [1.5. tee](#15-tee)
  - [1.6. wc](#16-wc)
  ...
  - [1.10. strace](#110-strace)
  - [1.11. pstack](#111-pstack)
  - [1.12. find与grep](#112-find与grep)
  - [1.13. PID](#113-pid)
  - [1.14. netstat](#114-netstat)
  - [1.15. netcat](#115-netcat)
  - [1.16. socat](#116-socat)
  - [1.17. traceroute](#117-traceroute)
  - [1.18. dmesg](#118-dmesg)
  - [1.19. vmstat](#119-vmstat)
  - [1.20. man](#120-man)
  - [1.21. ntsysv](#121-ntsysv)
  - [1.22. wget命令](#122-wget命令)
  - [1.23. 包管理](#123-包管理)
    - [1.23.1. 软件仓库](#1231-软件仓库)
    - [1.23.2. apt命令](#1232-apt命令)
    - [1.23.3. dpkg 命令](#1233-dpkg-命令)
  - [1.24. 防火墙](#124-防火墙)
    - [1.24.1. ubuntu下默认的防火墙](#1241-ubuntu下默认的防火墙)
    - [1.24.2. CentOS下默认的防火墙](#1242-centos下默认的防火墙)
  - [1.25. SELinux](#125-selinux)
  - [1.26. 参考](#126-参考)
