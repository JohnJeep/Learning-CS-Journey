 ...
 * @LastEditTime: 2023-12-01 10:28:02
...
<div align="center">
<img width="50%" hight="50%" src="./figure/index.png"/>
</div>
...
<div align="center">
<img width="50%" hight="50%" src="./figure/.git.png"/>
</div>
...
- 有些分支在远程其实早就被删除了，但是在你本地依然可以看见这些被删除的分支，可用下面的命令删除远程服务器上不再存在的远程分支引用。
  ...
  # 更新远程分支信息并清理不存在的分支引用，保持本地仓库和远程仓库的同步。
...
4. `git remote add origin git@github.com:michaelliao/learngit.git`  本地 Git 库与远程的仓库关联
