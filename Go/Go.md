...
1. [1. How to learn go(学习方法)](#1-how-to-learn-go学习方法)
2. [2. Concept(基本概念)](#2-concept基本概念)
    1. [2.1. 吉祥物](#21-吉祥物)
    2. [2.2. Go  mod](#22-go--mod)
2. [3. Golang 特点](#3-golang-特点)
    1. [3.1. 拥有特性](#31-拥有特性)
    2. [3.2. 不支持的特性](#32-不支持的特性)
    3. [3.3. 应用方向](#33-应用方向)
2. [4. Go 基础](#4-go-基础)
    1. [4.1. Agent(代理)](#41-agent代理)
    2. [4.2. 项目目录结构](#42-项目目录结构)
    3. [4.3. Compile(编译)](#43-compile编译)
    4. [4.4. built-in type(内置类型)](#44-built-in-type内置类型)
        1. [4.4.1. 值类型](#441-值类型)
        2. [4.4.2. 引用类型](#442-引用类型)
    2. [4.5. built-in function(内置函数)](#45-built-in-function内置函数)
        1. [4.5.1. append](#451-append)
        2. [4.5.2. copy](#452-copy)
        3. [4.5.3. make](#453-make)
        4. [4.5.4. new](#454-new)
    2. [4.6. 内置接口](#46-内置接口)
        1. [4.6.1. Error()](#461-error)
    2. [4.7. declare(声明)](#47-declare声明)
        1. [4.7.1. 变量声明](#471-变量声明)
        2. [4.7.2. 类型声明](#472-类型声明)
    2. [4.8. Unicode](#48-unicode)
    3. [4.9. Basic Data Types(基础数据类型)](#49-basic-data-types基础数据类型)
        1. [4.9.1. Constant(常量)](#491-constant常量)
        2. [4.9.2. iota](#492-iota)
        3. [4.9.3. String](#493-string)
        4. [4.9.4. any](#494-any)
    2. [4.10. Composite Types(复合类型)](#410-composite-types复合类型)
        1. [4.10.1. Array](#4101-array)
        2. [4.10.2. Slice](#4102-slice)
        3. [4.10.3. Map](#4103-map)
        4. [4.10.4. Struct](#4104-struct)
2. [5. 语言特性](#5-语言特性)
    1. [5.1. Function(函数)](#51-function函数)
        1. [5.1.1. 函数声明](#511-函数声明)
        2. [5.1.2. 多返回值](#512-多返回值)
        3. [5.1.3. 错误](#513-错误)
        4. [5.1.4. 匿名函数](#514-匿名函数)
        5. [5.1.5. 可变参数](#515-可变参数)
        6. [5.1.6. Panic(异常)](#516-panic异常)
        7. [5.1.7. defer(延迟调用)](#517-defer延迟调用)
        8. [5.1.8. Recover](#518-recover)
    2. [5.2. Object Oriented Programming(面向对象)](#52-object-oriented-programming面向对象)
        1. [5.2.1. Method(方法)](#521-method方法)
        2. [5.2.2. Encapsulation(封装)](#522-encapsulation封装)
        3. [5.2.3. Inheritance(继承)](#523-inheritance继承)
        4. [5.2.4. polymorphism(多态)](#524-polymorphism多态)
        5. [5.2.5. Interfaces(接口)](#525-interfaces接口)
        6. [5.2.6. Type Assertions(类型断言)](#526-type-assertions类型断言)
        7. [5.2.7. constructor(构造函数)](#527-constructor构造函数)
    2. [5.3. 泛型](#53-泛型)
2. [6. Concurrency(并发)](#6-concurrency并发)
    1. [6.1. Goroutine](#61-goroutine)
        1. [6.1.1. 概念](#611-概念)
        2. [6.1.2. 特点](#612-特点)
        3. [6.1.3. MPG模式](#613-mpg模式)
    2. [6.2. Channel](#62-channel)
        1. [6.2.1. 声明 channel](#621-声明-channel)
        2. [6.2.2. 创建 channel](#622-创建-channel)
        3. [6.2.3. 关闭 channel](#623-关闭-channel)
        4. [6.2.4. 遍历 channel](#624-遍历-channel)
        5. [6.2.5. 注意事项](#625-注意事项)
2. [7. Package(包)](#7-package包)
    1. [7.1. init 函数](#71-init-函数)
    2. [7.2. 包的作用](#72-包的作用)
    3. [7.3. 注意事项](#73-注意事项)
    4. [7.4. 包之间调用](#74-包之间调用)
    5. [7.5. 打包](#75-打包)
    6. [7.6. 导入包](#76-导入包)
2. [8. Testing(测试)](#8-testing测试)
    1. [8.1. 测试函数](#81-测试函数)
    2. [8.2. 基准测试](#82-基准测试)
    3. [8.3. Coverage(测试覆盖率)](#83-coverage测试覆盖率)
2. [9. Reflection(反射)](#9-reflection反射)
    1. [9.1. 概念](#91-概念)
    2. [9.2. 重要API函数](#92-重要api函数)
    3. [9.3. 注意事项](#93-注意事项)
2. [10. Garbage Collector(垃圾回收)](#10-garbage-collector垃圾回收)
3. [11. Reference](#11-reference)
