...
- 使用规则
  ...
  - 如果函数的参数可以是 `任意类型指针`，那么应声明其参数为 void * 
...
- `void` 的出现只是为了一种抽象的需要，像在面向对象中，不能给 `抽象基类` 定义一个实例，因此不能定义一个 void 变量。


## 1.3. 参考
- [void 与 void*详解](https://www.cnblogs.com/eleclsc/p/5890163.html)
