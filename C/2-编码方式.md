 ...
 * @LastEditTime: 2020-06-03 15:37:17
...
- Unicode
  ...
  <div align="center"><img src="./figure/Unicode-UTF-8转换.png"></div>
  <div align="center"><img src="./figure/Unicode-浏览器.png"></div>
- 中文编码: GB2312
  - 采用两个字节表示一个汉字
...
- UTF-8 (Unicode Transformation Format 8)
  ...
  <div align="center"><img src="./figure/Unicode编号.png" width="50%"  height="50%"></div>
...
- 大小端是针对大于一个字节的数的存储问题而言的
  - 大端法：低地址存储高字节
  - 小端法：低地址存储低字节
  <div  align="center"><img src="./figure/大端法存储.png" width="50%" height="50%"></div>
