...
- [0.4. 结构型 - 设计模式](#04-结构型---设计模式)
  ...
  - [0.4.6. 享元类](#046-享元类)
- [0.5. 行为型模式](#05-行为型模式)
  - [0.5.1. **模板模式(template pattern)**](#051-模板模式template-pattern)
  - [0.5.2. **命令模式(command pattern)**](#052-命令模式command-pattern)
  - [0.5.3. **策略模式(strategy pattern)**](#053-策略模式strategy-pattern)
  - [0.5.4. **中介者模式(mediator pattern)**](#054-中介者模式mediator-pattern)
  - [0.5.5. **观察者模式(observer pattern)**](#055-观察者模式observer-pattern)
  - [0.5.6. **迭代模式(iterator pattern)**](#056-迭代模式iterator-pattern)
  - [0.5.7. **访问者模式(visitor pattern)**](#057-访问者模式visitor-pattern)
  - [0.5.8. 责任链模式（chain of responsibility pattern）](#058-责任链模式chain-of-responsibility-pattern)
  - [0.5.9. 备忘录模式(memento pattern)](#059-备忘录模式memento-pattern)
  - [0.5.10. 状态模式(state pattern)](#0510-状态模式state-pattern)
  - [0.5.11. 解释模式(interpreter pattern)](#0511-解释模式interpreter-pattern)
...
### 0.5.3. **策略模式(strategy pattern)**



### 0.5.4. **中介者模式(mediator pattern)**



### 0.5.5. **观察者模式(observer pattern)**
- 观察者模式概述
...
### 0.5.8. 责任链模式（chain of responsibility pattern）
有一个指向当前类的指针。


### 0.5.9. 备忘录模式(memento pattern)


### 0.5.10. 状态模式(state pattern)


### 0.5.11. 解释模式(interpreter pattern)