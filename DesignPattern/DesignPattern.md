 ...
 * @LastEditTime: 2021-03-09 14:00:36
...
- [0.5. Creational patterns(创建型模式)](#05-creational-patterns创建型模式)
  - [0.5.1. **Singleton(单例模式)**](#051-singleton单例模式)
    - [0.5.1.1. 什么是单例模式？](#0511-什么是单例模式)
    - [0.5.1.2. 实现的步骤](#0512-实现的步骤)
    - [0.5.1.3. 单例模式优点](#0513-单例模式优点)
    - [0.5.1.4. 注意事项](#0514-注意事项)
    - [0.5.1.5. 单线程下实现单例模式](#0515-单线程下实现单例模式)
    - [0.5.1.6. 多线程下实现单例模式](#0516-多线程下实现单例模式)
  - [0.5.2. **Factory Method(工厂模式)**](#052-factory-method工厂模式)
    - [0.5.2.1. 什么是 Factory Method ？](#0521-什么是-factory-method-)
    - [0.5.2.2. 优点](#0522-优点)
    - [0.5.2.3. 缺点](#0523-缺点)
  - [0.5.3. **Abstract Factory(抽象工厂模式)**](#053-abstract-factory抽象工厂模式)
    - [0.5.3.1. 什么是抽象工厂模式？](#0531-什么是抽象工厂模式)
    - [0.5.3.2. UML图](#0532-uml图)
    - [0.5.3.3. 优点](#0533-优点)
    - [0.5.3.4. 缺点](#0534-缺点)
    - [0.5.3.5. 工厂模式与抽象工厂模式的区别](#0535-工厂模式与抽象工厂模式的区别)
  - [0.5.4. **Builder(建造者模式)**](#054-builder建造者模式)
    - [0.5.4.1. 什么是建造者模式?](#0541-什么是建造者模式)
    - [0.5.4.2. 适用性](#0542-适用性)
    - [0.5.4.3. UML图](#0543-uml图)
    - [0.5.4.4. 优点](#0544-优点)
    - [0.5.4.5. 缺点](#0545-缺点)
  - [0.5.5. Prototype(原型模式)](#055-prototype原型模式)
    - [0.5.5.1. 什么是原型模式？](#0551-什么是原型模式)
    - [0.5.5.2. 优点](#0552-优点)
    - [0.5.5.3. 缺点](#0553-缺点)
- [0.6. Structural patterns(结构型模式)](#06-structural-patterns结构型模式)
  - [0.6.1. Composite(组合模式)](#061-composite组合模式)
    - [0.6.1.1. 什么是组合模式？](#0611-什么是组合模式)
  - [0.6.2. **Proxy(代理模式)**](#062-proxy代理模式)
    - [0.6.2.1. 什么是代理模式？](#0621-什么是代理模式)
    - [0.6.2.2. 优点](#0622-优点)
    - [0.6.2.3. 缺点](#0623-缺点)
  - [0.6.3. **Decorator装饰器模式)**](#063-decorator装饰器模式)
    - [0.6.3.1. 什么是装饰器模式？](#0631-什么是装饰器模式)
  - [0.6.4. **Adapter(适配器)**](#064-adapter适配器)
    - [0.6.4.1. 什么是适配器模式？](#0641-什么是适配器模式)
  - [0.6.5. **Bridge(桥接模式)**](#065-bridge桥接模式)
    - [0.6.5.1. 什么是桥接模式？](#0651-什么是桥接模式)
  - [0.6.6. Facade(外观模式)](#066-facade外观模式)
    - [0.6.6.1. 什么是外观模式？](#0661-什么是外观模式)
    - [0.6.6.2. Facade模式概述](#0662-facade模式概述)
    - [0.6.6.3. 优点](#0663-优点)
    - [0.6.6.4. 缺点](#0664-缺点)
  - [0.6.7. Flyweight(享元模式)](#067-flyweight享元模式)
    - [0.6.7.1. 什么是享元模式？](#0671-什么是享元模式)
    - [0.6.7.2. 优点](#0672-优点)
    - [0.6.7.3. 缺点](#0673-缺点)
- [0.7. Behavioural patterns(行为型模式)](#07-behavioural-patterns行为型模式)
  - [0.7.1. **Template Method(模板方法模式)**](#071-template-method模板方法模式)
    - [0.7.1.1. 模板模式概述](#0711-模板模式概述)
    - [0.7.1.2. 什么是模板方法模式？](#0712-什么是模板方法模式)
    - [0.7.1.3. UML图](#0713-uml图)
    - [0.7.1.4. 优点](#0714-优点)
    - [0.7.1.5. 缺点](#0715-缺点)
    - [0.7.1.6. 应用场景](#0716-应用场景)
  - [0.7.2. **command(命令模式)**](#072-command命令模式)
    - [0.7.2.1. 命令行模式概述](#0721-命令行模式概述)
    - [0.7.2.2. 什么是命令模式？](#0722-什么是命令模式)
    - [0.7.2.3. UML图](#0723-uml图)
    - [0.7.2.4. 优点](#0724-优点)
    - [0.7.2.5. 缺点](#0725-缺点)
    - [0.7.2.6. 应用场景](#0726-应用场景)
  - [0.7.3. **strategy(策略模式)**](#073-strategy策略模式)
    - [0.7.3.1. 什么是策略模式？](#0731-什么是策略模式)
  - [0.7.4. **mediator(中介者模式)**](#074-mediator中介者模式)
    - [0.7.4.1. 什么是中介者模式？](#0741-什么是中介者模式)
  - [0.7.5. **observer(观察者模式)**](#075-observer观察者模式)
    - [0.7.5.1. 什么是观察者模式？](#0751-什么是观察者模式)
    - [0.7.5.2. 为什么要用observer？](#0752-为什么要用observer)
    - [0.7.5.3. 怎样去使用observer？](#0753-怎样去使用observer)
    - [0.7.5.4. UML图](#0754-uml图)
    - [0.7.5.5. 执行步骤](#0755-执行步骤)
    - [0.7.5.6. 优点](#0756-优点)
    - [0.7.5.7. 缺点](#0757-缺点)
    - [0.7.5.8. 使用时注意事项？](#0758-使用时注意事项)
    - [0.7.5.9. Relations with Other Patterns](#0759-relations-with-other-patterns)
  - [0.7.6. **iterator(迭代器模式)**](#076-iterator迭代器模式)
    - [0.7.6.1. 什么是迭代器模式？](#0761-什么是迭代器模式)
    - [0.7.6.2. UML图](#0762-uml图)
    - [0.7.6.3. 优点](#0763-优点)
    - [0.7.6.4. 缺点](#0764-缺点)
    - [0.7.6.5. 应用场景](#0765-应用场景)
  - [0.7.7. **visitor(访问者模式)**](#077-visitor访问者模式)
    - [0.7.7.1. 访问者模式概述](#0771-访问者模式概述)
    - [0.7.7.2. 什么是访问者模式？](#0772-什么是访问者模式)
    - [0.7.7.3. UML图](#0773-uml图)
    - [0.7.7.4. 优点](#0774-优点)
    - [0.7.7.5. 缺点](#0775-缺点)
    - [0.7.7.6. 应用场景](#0776-应用场景)
  - [0.7.8. chain of responsibility(责任链模式)](#078-chain-of-responsibility责任链模式)
    - [0.7.8.1. 什么是责任链模式？](#0781-什么是责任链模式)
  - [0.7.9. memento(备忘录模式)](#079-memento备忘录模式)
    - [0.7.9.1. 什么是备忘录模式？](#0791-什么是备忘录模式)
  - [0.7.10. state(状态模式)](#0710-state状态模式)
    - [0.7.10.1. 什么是状态模式？](#07101-什么是状态模式)
  - [0.7.11. interpreter(解释器模式)](#0711-interpreter解释器模式)
    - [0.7.11.1. 什么是解释器模式？](#07111-什么是解释器模式)
...
### 0.5.2. **Factory Method(工厂模式)**
#### 0.5.2.1. 什么是 Factory Method ？
...
## 0.6. Structural patterns(结构型模式)

### 0.6.1. Composite(组合模式)
#### 0.6.1.1. 什么是组合模式？
组合模式是将对象组合成树形结构以表示“部分-整体”的层次结构。 Composite使得客户对单个对象和复合对象的使用具有一致性。
...
### 0.6.3. **Decorator装饰器模式)**
#### 0.6.3.1. 什么是装饰器模式？
装饰模式是动态地给一个对象添加一些额外的职责。就扩展功能而言， Decorator模式比生成子类方式更为灵活。
...
### 0.6.4. **Adapter(适配器)**
#### 0.6.4.1. 什么是适配器模式？
适配器模式是将一个类的接口转换成客户希望的另外一个接口。 Adapter模式使得原本由于接口不兼容而不能一起工作的那些类可以一起工作。
...
## 0.7. Behavioural patterns(行为型模式)
### 0.7.1. **Template Method(模板方法模式)**
参考
...
### 0.7.4. **mediator(中介者模式)**
#### 0.7.4.1. 什么是中介者模式？
用一个中介对象来封装一系列的对象交互。中介者使各对象不需要显式地相互引用，从而使其耦合松散，而且可以独立地改变它们之间的交互。


### 0.7.5. **observer(观察者模式)**
#### 0.7.5.1. 什么是观察者模式？
...
- 结合观察目标类和观察者类。用不支持多重继承的语言(如Smalltalk)书写的类库通常不单独定义 Subject 和 Observer 类, 而是将它们的接口结合到一个类中。这就允许你定义一个既是一个观察目标又是一个观察者的对象，而不需要多重继承。


#### 0.7.5.9. Relations with Other Patterns
...
### 0.7.8. chain of responsibility(责任链模式)
#### 0.7.8.1. 什么是责任链模式？
