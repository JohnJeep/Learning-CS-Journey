 ...
 * @LastEditTime: 2026-05-31 18:31:12
 * @Description: C++20 new features
...
### 1.1. 🎯 四大支柱特性
1. **模块（Modules）** - 替代头文件 include 的现代化构建方式
...
- `std::partial_ordering` - 部分有序（如浮点数，有 NaN）
