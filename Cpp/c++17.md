 ...
 * @LastEditTime: 2025-11-20 11:50:03
 * @Description: C++17 新特性
...
- [1. 整体认识](#1-整体认识)
- [2. 第二部分：逐个特性详解](#2-第二部分逐个特性详解)
  - [2.1. 语言核心特性](#21-语言核心特性)
    - [2.1.1. 结构化绑定](#211-结构化绑定)
    - [2.1.2. 类模板参数推导](#212-类模板参数推导)
    - [2.1.3. `constexpr if`](#213-constexpr-if)
    - [2.1.4. 初始化语句的`if`和`switch`](#214-初始化语句的if和switch)
    - [2.1.5. 内联变量](#215-内联变量)
    - [2.1.6. 折叠表达式](#216-折叠表达式)
    - [2.1.7. 嵌套命名空间定义](#217-嵌套命名空间定义)
    - [2.1.8. `__has_include` 预处理表达式](#218-__has_include-预处理表达式)
    - [2.1.9. UTF-8 字符字面量](#219-utf-8-字符字面量)
    - [2.1.10. 确保拷贝消除](#2110-确保拷贝消除)
  - [2.2. 标准库新组件](#22-标准库新组件)
    - [2.2.1. `std::optional<T>`](#221-stdoptionalt)
    - [2.2.2. `std::variant<Types...>`](#222-stdvarianttypes)
    - [2.2.3. `std::any`](#223-stdany)
    - [2.2.4. `std::string_view`](#224-stdstring_view)
    - [2.2.5. 文件系统库 (`std::filesystem`)](#225-文件系统库-stdfilesystem)
    - [2.2.6. 并行算法](#226-并行算法)
  - [2.3. 其他重要特性](#23-其他重要特性)
- [3. 总结](#3-总结)
