 ...
 * @LastEditTime: 2025-11-20 11:32:54
 * @Description: C++ 基础
...
- [5. Reference(引用)](#5-reference引用)
  - [5.1. Ordinary Reference(普通引用)](#51-ordinary-reference普通引用)
    - [5.1.1. 引用初始化](#511-引用初始化)
    - [5.1.2. 引用使用时注意点](#512-引用使用时注意点)
  - [5.2. const reference(常量引用)](#52-const-reference常量引用)
  - [5.3. 指针的引用(reference to pointer)](#53-指针的引用reference-to-pointer)
    - [5.3.1. 主要用途](#531-主要用途)
      - [5.3.1.1. 在函数中修改指针本身](#5311-在函数中修改指针本身)
      - [5.3.1.2. 动态数据结构操作](#5312-动态数据结构操作)
      - [5.3.1.3. 实现指针的交换](#5313-实现指针的交换)
      - [5.3.1.4. 多级指针的替代方案](#5314-多级指针的替代方案)
      - [5.3.1.5. 在面向对象编程中的应用](#5315-在面向对象编程中的应用)
    - [5.3.2. 与普通指针参数的区别](#532-与普通指针参数的区别)
    - [5.3.3. 总结](#533-总结)
- [6. pass by value \&\& pass by reference](#6-pass-by-value--pass-by-reference)
- [7. function(函数)](#7-function函数)
  - [7.1. inline(内联函数)](#71-inline内联函数)
...
- [9. Special member function (特别成员函数)](#9-special-member-function-特别成员函数)
  - [9.1. Constructor(构造函数)](#91-constructor构造函数)
    - [9.1.1. 为什么要用构造函数](#911-为什么要用构造函数)
    - [9.1.2. 构造函数特征](#912-构造函数特征)
    - [9.1.3. 构造函数注意点](#913-构造函数注意点)
    - [9.1.4. 类中默认的构造函数](#914-类中默认的构造函数)
    - [9.1.5. 构造函数分类](#915-构造函数分类)
    - [9.1.6. Initialization(初始化)](#916-initialization初始化)
  - [9.2. Copy Constructor(拷贝构造)](#92-copy-constructor拷贝构造)
    - [9.2.1. Shallow Copy(浅拷贝)](#921-shallow-copy浅拷贝)
    - [9.2.2. Deep Copy(深拷贝)](#922-deep-copy深拷贝)
    - [9.2.3. 什么时候用深拷贝和浅拷贝？](#923-什么时候用深拷贝和浅拷贝)
  - [9.3. Copy Assignment Operator(拷贝赋值运算)](#93-copy-assignment-operator拷贝赋值运算)
  - [9.4. Destructor(析构函数)](#94-destructor析构函数)
- [10. empty class](#10-empty-class)
- [11. class object \&\& class pointer](#11-class-object--class-pointer)
- [12. new \&\& delete](#12-new--delete)
- [13. overload(重载)](#13-overload重载)
- [14. override(重写)](#14-override重写)
- [15. const](#15-const)
- [16. static](#16-static)
- [17. this](#17-this)
- [18. mutable](#18-mutable)
  - [18.1. mutable是什么？](#181-mutable是什么)
  - [18.2. 为什么要用 mutable？](#182-为什么要用-mutable)
  - [18.3. 使用 mutable 的注意事项](#183-使用-mutable-的注意事项)
  - [18.4. 常函数](#184-常函数)
- [19. friend(友元)](#19-friend友元)
    - [19.0.1. 主要特性：](#1901-主要特性)
    - [19.0.2. 主要用法：](#1902-主要用法)
    - [19.0.3. 使用场景：](#1903-使用场景)
- [20. typename](#20-typename)
  - [20.1. 概念](#201-概念)
  - [20.2. 为什么要用 typename ?](#202-为什么要用-typename-)
  - [20.3. 注意点](#203-注意点)
- [21. explicit conversions(显示类型转换)](#21-explicit-conversions显示类型转换)
  - [21.1. static\_cast\<\>()](#211-static_cast)
  - [21.2. reinterpret\_cast\<\>()](#212-reinterpret_cast)
  - [21.3. dynamic\_cast\<\>()](#213-dynamic_cast)
  - [21.4. const\_cast\<\>()](#214-const_cast)
- [22. exception(异常处理)](#22-exception异常处理)
  - [22.1. 异常变量的生命周期](#221-异常变量的生命周期)
  - [22.2. 异常的层次结构](#222-异常的层次结构)
  - [22.3. 异常的优缺点](#223-异常的优缺点)
  - [22.4. 构造函数中的异常](#224-构造函数中的异常)
- [23. Meaningful aphorisms (隽永警句)](#23-meaningful-aphorisms-隽永警句)
- [24. References by websites](#24-references-by-websites)
